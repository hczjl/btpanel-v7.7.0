...
Install_RPM_Pack(){
	...
	#	curl -Ss --connect-timeout 3 -m 60 https://raw.githubusercontent.com/hczjl/btpanel-v7.7.0/main/install/yumRepo_select.sh|bash
	#fi
...
Install_Python_Lib(){
	curl -Ss --connect-timeout 3 -m 60 https://raw.githubusercontent.com/hczjl/btpanel-v7.7.0/main/install/pip_select.sh|bash
...
Install_Bt(){
	...
	wget -O /etc/init.d/bt https://raw.githubusercontent.com/hczjl/btpanel-v7.7.0/main/install/src/bt6.init -T 10
	wget -O /www/server/panel/install/public.sh https://raw.githubusercontent.com/hczjl/btpanel-v7.7.0/main/install/public.sh -T 10
	wget -O panel.zip https://raw.githubusercontent.com/hczjl/btpanel-v7.7.0/main/install/src/panel6.zip -T 10
	...
	wget -O /etc/init.d/bt https://raw.githubusercontent.com/hczjl/btpanel-v7.7.0/main/install/src/bt7.init -T 10
	wget -O /www/server/panel/init.sh https://raw.githubusercontent.com/hczjl/btpanel-v7.7.0/main/install/src/bt7.init -T 10
